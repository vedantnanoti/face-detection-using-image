...
# The Haarcascade file is trained for face detection.
print(os.listdir(cv2.data.haarcascades))
filename = "haarcascade_frontalface_default.xml"

# Finding the path of the haarcascade file from the print statement above.
...
# The function also returns the coordinates of the detected faces.
...
# Converting the image into a 3D array in BGR format.
# After line 25, we have successfully created a box around the face and now display the image using imshow().
cv2.imshow("me", image)
